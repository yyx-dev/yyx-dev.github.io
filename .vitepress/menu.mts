export const menu = [
  {
    text: "408",
    items: [
      { text: "数据结构", link: "/docs/408/01-数据结构" },
      { text: "计算机组成原理", link: "/docs/408/02-计算机组成原理" },
      { text: "操作系统", link: "/docs/408/03-操作系统" },
      { text: "计算机网络", link: "/docs/408/04-计算机网络" },
      { text: "基础题型", items: [
        { text: "数据结构基础题型", link: "/docs/408/05-数据结构基础题型.md" },
        { text: "计组基础题型", link: "/docs/408/06-计组基础题型.md" },
        { text: "操作系统基础题型", link: "/docs/408/07-操作系统基础题型.md" },
        { text: "计网基础题型", link: "/docs/408/08-计网基础题型.md" },
      ]},
      { text: "强化题型", items: [
        { text: "数据结构强化题型", link: "/docs/408/09-数据结构强化题型.md" },
        { text: "计组强化题型", link: "/docs/408/10-计组强化题型.md" },
        { text: "操作系统强化题型", link: "/docs/408/11-操作系统强化题型.md" },
        { text: "计网强化题型", link: "/docs/408/12-计网强化题型.md" },
      ]},
    ],
  },
  {
