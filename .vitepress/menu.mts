export const menu = [
  {
    ...
    items: [
      ...
      { text: "基础题型", items: [
        { text: "计组基础题型", link: "/docs/408/5-计组基础题型.md" },
        { text: "操作系统基础题型", link: "/docs/408/6-操作系统基础题型.md" },
      ]},
      { text: "强化题型", items: [
        { text: "计组强化题型", link: "/docs/408/7-计组强化题型.md" },
        { text: "操作系统强化题型", link: "/docs/408/8-操作系统强化题型.md" },
      ]},
    ],
  },
  {
