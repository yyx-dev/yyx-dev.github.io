export const menu = [
  {
    ...
    items: [
      ...
      { text: "基础题型", items: [
        { text: "数据结构", link: "/docs/408/05-数据结构基础题型" },
        { text: "计算机组成原理", link: "/docs/408/06-计组基础题型" },
        { text: "操作系统", link: "/docs/408/07-操作系统基础题型" },
        { text: "计算机网络", link: "/docs/408/08-计网基础题型" },
      ]},
      { text: "强化题型", items: [
        { text: "数据结构", link: "/docs/408/09-数据结构强化题型" },
