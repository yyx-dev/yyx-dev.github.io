export const menu = [
  {
    ...
    items: [
      ...
      { text: "基础题型", items: [
        { text: "数据结构基础", link: "/docs/408/05-数据结构基础.md" },
        { text: "计组基础", link: "/docs/408/06-计组基础.md" },
        { text: "操作系统基础", link: "/docs/408/07-操作系统基础.md" },
        { text: "计网基础", link: "/docs/408/08-计网基础.md" },
      ]},
      { text: "强化题型", items: [
        { text: "数据结构强化", link: "/docs/408/09-数据结构强化.md" },
        { text: "计组强化", link: "/docs/408/10-计组强化.md" },
        { text: "操作系统强化", link: "/docs/408/11-操作系统强化.md" },
        { text: "计网强化", link: "/docs/408/12-计网强化.md" },
      ]},
    ],
  },
  {
