...
<center>
<img src="./09-字符串和内存函数.assets/strcpy拷贝源字符串包括null.png" style="zoom: 70%;" />
</center>

> 拷贝时会把`\0`也一同拷贝。若源字符串中有`\0`，其后的元素自然是不会被拷贝的，因为在读取时也就把`\0`作为结束标志。

<center>
<img src="./09-字符串和内存函数.assets/strcpy源字符串不含null报错示例.png" style="zoom: 70%;" />
</center>
...
<center>
<img src="./09-字符串和内存函数.assets/strcat源字符串不含null报错示例.png" style="zoom: 60%;" />
</center>
...
<center>
<img src="./09-字符串和内存函数.assets/strncpy源字符串个数不足以null填充.png"  style="zoom: 60%;" />
</center>
...
<center>
<img src="./09-字符串和内存函数.assets/memmove内存重叠拷贝示例.png"  style="zoom: 60%;" />
</center>

#### 实现方案

<center>
<img src="./09-字符串和内存函数.assets/memmove实现方案分析.png"  style="zoom: 60%;" />
</center>
