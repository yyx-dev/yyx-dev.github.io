...
<img src="./11-动态内存管理.assets/简单内存划分示例.png" style="zoom: 50%;" />
...
<img src="./11-动态内存管理.assets/realloc紧接原空间开辟.png" style="zoom: 40%;" />

2. 当原空间后无足够大小时，就在堆区寻找新空间，再将原空间的内容移动到新空间，返回新空间的地址且释放原空间。

<img src="./11-动态内存管理.assets/realloc开辟新空间并释放原空间.png" style="zoom: 40%;" />

3. 当剩余空间不够无法开辟时，增容失败，返回`NULL`。
...
<img src="./11-动态内存管理.assets/变量解析内存划分示例.png" style="zoom: 50%;" />
...
<img src="./11-动态内存管理.assets/sizeof计算含柔性数组的结构体大小.png" style="zoom: 60%;" />

### 柔性数组的使用

<img src="./11-动态内存管理.assets/为柔性数组结构体开辟空间代码.png" style="zoom: 60%;" />
