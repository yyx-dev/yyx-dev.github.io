...
<center>
<img src="./11-动态内存管理.assets/简单内存划分示例.png" style="zoom:80%;" />
</center>
...
<center>
<img src="./11-动态内存管理.assets/realloc紧接原空间开辟.png" style="zoom:80%;" />
</center>

- 当原空间后无足够大小时，就在堆区寻找新空间，再将原空间的内容移动到新空间，返回新空间的地址且释放原空间。

<center>
<img src="./11-动态内存管理.assets/realloc开辟新空间并释放原空间.png" style="zoom:80%;" />
</center>
...
<center>
<img src="./11-动态内存管理.assets/变量解析内存划分示例.png" style="zoom:80%;" />
</center>
...
<center>
<img src="./11-动态内存管理.assets/为柔性数组结构体开辟空间代码.png" style="zoom:80%;" />
</center>
