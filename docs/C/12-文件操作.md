...
<center>
<img src="./12-文件操作.assets/程序文件和数据文件.png" style="zoom:80%;" />
</center>
...
<center>
<img src="./12-文件操作.assets/文件标识示例.png" style="zoom:80%;" />
</center>
...
<center>
<img src="./12-文件操作.assets/数值保存为二进制形式和文本形式对比.png" style="zoom:80%;" />
</center>
...
<center>
<img src="./12-文件操作.assets/内存外存数据传递.png" style="zoom:80%;" />
</center>
...
<center>
<img src="./12-文件操作.assets/文件信息区与文件关系示例.png" style="zoom:80%;" />
</center>
...
<center>
<img src="./12-文件操作.assets/文件信息区结构体内容代码.png" style="zoom:80%;" />
</center>
...
<center>
<img src="./12-文件操作.assets/文件指针指向文件信息区.png" style="zoom:80%;" />
</center>
...
<center>
<img src="./12-文件操作.assets/流的含义.png" style="zoom:80%;" />
</center>
...
<center>
<img src="./12-文件操作.assets/顺序读写函数数据和文件关系对比.png" style="zoom:80%;" />
</center>
...
<center>
<img src="./12-文件操作.assets/fgetc和fputc函数声明对比.png" style="zoom:80%;" />
</center>
...
<center>
<img src="./12-文件操作.assets/fgets和fputs函数声明对比.png" style="zoom:80%;" />
</center>
...
<center>
<img src="./12-文件操作.assets/fgets函数示例解析.png" style="zoom:80%;" />
</center>
...
<center>
<img src="./12-文件操作.assets/fscanf和fprintf函数声明对比.png" style="zoom:80%;" />
</center>
...
<center>
<img src="./12-文件操作.assets/fread和fwrite函数声明对比.png" style="zoom:80%;" />
</center>
...
<center>
<img src="./12-文件操作.assets/fwrite写入二进制文件的形式对比.png" style="zoom:80%;" />
</center>

- `fread`把从文件`stream`的中`count`个大小为`size`的元素以二进制的形式读取到`buffer`中。

<center>
<img src="./12-文件操作.assets/fread读取二进制文件内容对比.png" style="zoom:80%;" />
</center>
...
<center>
<img src="./12-文件操作.assets/scanf和printf函数声明对比.png" style="zoom:80%;" />
</center>
...
<center>
<img src="./12-文件操作.assets/fseek函数origin可取值的意义.png" style="zoom:80%;" />
</center>
