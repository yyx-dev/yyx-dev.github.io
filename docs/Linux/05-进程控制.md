...
<center>
<img src="./05-进程控制.assets/C语言错误码对应信息.png" style="zoom:40%;" />
</center>
...
<center>
<img src="./05-进程控制.assets/exit结束进程并自动刷新缓冲区示例.gif" style="zoom: 40%;" />
</center>
...
<center>
<img src="./05-进程控制.assets/waitpid输出型参数status内容示例.png" style="zoom: 33%;" />
</center>
...
<center>
<img src="./05-进程控制.assets/status次低八位获取子进程退出码示例.png" style="zoom:40%;" />
</center>
...
<center>
<img src="./05-进程控制.assets/waitpid轮询检测结果示例.png" style="zoom:40%;" />
</center>
...
<center>
<img src="./05-进程控制.assets/打开Core Dump功能.png" style="zoom:45%;" />
</center>

core dump可以帮助我们更加方便地调试，可以直接显示错误的行数。进入gdb后输入`core-file core.pid`加载core文件。

<center>
<img src="./05-进程控制.assets/core dump事后调试示例.png"  style="zoom: 45%;" />
</center>
...
<center>
<img src="./05-进程控制.assets/waitpid理解示例.png" style="zoom:50%;" />
</center>
...
<center>
<img src="./05-进程控制.assets/进程替换原理.png" style="zoom:50%;" />
</center>
...
<center>
<img src="./05-进程控制.assets/execle替换程序传入置顶环境变量示例.png"  style="zoom:50%;"/>
</center>
...
<center>
<img src="./05-进程控制.assets/进程程序替换函数之间的关系.png" style="zoom:50%;" />
</center>
