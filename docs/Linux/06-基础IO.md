...
<img src="./06-基础IO.assets/用户文件操作需经操作系统.png" style="zoom: 40%;" />
...
<img src="./06-基础IO.assets/进程文件管理结构.png" style="zoom: 35%;" />
...
<img src="./06-基础IO.assets/给新文件分配文件描述符示例.png" style="zoom: 60%;" />
...
<img src="./06-基础IO.assets/FILE文件结构体中的fd.png" style="zoom: 40%;" />
...
<img src="./06-基础IO.assets/dup2重定向文件原理.gif" style="zoom: 60%;" />
...
<img src="./06-基础IO.assets/以文件读写描述硬件.png" style="zoom: 40%;" />
...
<img src="./06-基础IO.assets/open不指定mode参数造成文件权限混乱示例.png" style="zoom: 45%;" />
...
<img src="./06-基础IO.assets/输出所经用户和内核缓冲区示例.png" style="zoom: 30%;" />
...
<img src="./06-基础IO.assets/磁盘物理结构.png" alt="磁盘物理结构" style="zoom: 38%;" />
...
<img src="./06-基础IO.assets/盘片磁道视为线性结构.png" style="zoom: 33%;" />
...
<img src="./06-基础IO.assets/Inode和Block的含义.png" style="zoom: 30%;" />
...
<img src="./06-基础IO.assets/位图结构.png" style="zoom: 40%;" />
...
<img src="./06-基础IO.assets/inode直接和间接索引.png" style="zoom: 50%;" />
...
<img src="./06-基础IO.assets/创建文件在系统中的本质示例.png" style="zoom: 33%;" />
...
```shell
$ ln -s myvar(--vp-c-bg-soft) myvar(--vp-c-bg-soft)_link # 创建软链接
$ ln    myvar(--vp-c-bg-soft) myvar(--vp-c-bg-soft)_hard # 创建硬链接

$ unlink myvar(--vp-c-bg-soft)_hard       # 取消硬链接
$ unlink myvar(--vp-c-bg-soft)_link       # 取消软链接
```

#### 软硬链接的区别

```shell
$ ln tmp/var(--vp-c-bg-soft) myvar(--vp-c-bg-soft)_soft -s
$ ln tmp/var(--vp-c-bg-soft) myvar(--vp-c-bg-soft)_hard
$ ll -i
total 8
...
```shell
$ stat var(--vp-c-bg-soft).c   # 获取文件的状态信息
  File: ‘var(--vp-c-bg-soft).c’
...
<img src="./06-基础IO.assets/三个文件状态时间示例.png" style="zoom: 40%;" />
...
```shell
$ gcc var(--vp-c-bg-soft).c -Iinc  -Llib  -lmath [-static]
```
...
<img src="./06-基础IO.assets/动态链接的本质.png" style="zoom: 50%;" />
...
<img src="./06-基础IO.assets/与地址无关码.png" style="zoom: 40%;" />
