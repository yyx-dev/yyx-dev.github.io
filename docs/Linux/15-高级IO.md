...
<img src="./15-高级IO.assets/IO事件就绪.png" style="zoom: 30%;" />
...
<img src="./15-高级IO.assets/fd_set位图类型示例.png" style="zoom: 35%;" />
    ...
    void handler_event(fd_collection& resfds) {
        for (auto fd : _fds._fdarr) {
            ...
            if (resfds._wfds.isset(fd)) {
                std::string msg = "var(--vp-c-bg-soft)";
                sender(fd, msg);
            }
...
<img src="./15-高级IO.assets/epoll工作原理.png" style="zoom: 40%;" />
