...
<img src="./5-二叉搜索树.assets/搜索二叉树退化.png" style="zoom: 30%;" />
...
<img src="./5-二叉搜索树.assets/二叉搜索树查找过程示例.gif" style="zoom: 50%;" />
...
<img src="./5-二叉搜索树.assets/二叉搜索树插入新节点示例.gif" style="zoom: 50%;" />
...
<img src="./5-二叉搜索树.assets/二叉搜索树简单删除示例.gif" style="zoom: 50%;" />

| 替换删除                 | 解释                                               |
| ------------------------ | -------------------------------------------------- |
| 删除的节点左右子节点都有 | 用左树的最大节点，或右树的最小节点，替换被删节点。 |

<img src="./5-二叉搜索树.assets/二叉搜索树替换法删除示例.gif" style="zoom: 50%;" />
...
<img src="./5-二叉搜索树.assets/二叉搜索树删除代码分析.png" style="zoom: 50%;" />
