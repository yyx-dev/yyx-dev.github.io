...
<center>
<img src="./6-八大排序.assets/直接插排摸扑克牌示例.png" style="zoom: 50%;" />
</center>
...
<center>
<img src="./6-八大排序.assets/直接插排end的移动范围.png" style="zoom: 50%;" />
</center>
...
<center>
<img src="./6-八大排序.assets/外循环控制end.gif" style="zoom: 50%;" />
</center>
...
<center>
<img src="./6-八大排序.assets/直接插排.gif" style="zoom: 50%;" />
</center>
...
<center>
<img src="./6-八大排序.assets/希尔排序按gap分组预排序数组.png" style="zoom: 50%;" />
</center>
...
<center>
<img src="./6-八大排序.assets/希尔排序预排序.gif" style="zoom: 50%;" />
</center>

> 预排序所得结果虽不是完全有序，但相对于原数组确实是更加有序的。

<center>
<img src="./6-八大排序.assets/希尔排序预排序结果.png" style="zoom: 50%;" />
</center>
...
<center>
<img src="./6-八大排序.assets/希尔排序简化并行预排序.gif" style="zoom: 50%;" />
</center>
...
<center>
<img src="./6-八大排序.assets/选择排序.gif" style="zoom: 50%;" />
</center>
...
<center>
<img src="./6-八大排序.assets/选择排序同时找最值.gif" style="zoom: 50%;" />
</center>
...
<center>
<img src="./6-八大排序.assets/堆排序流程例.png" style="zoom: 50%;" />
</center>

#### 代码实现

<center>
<img src="./6-八大排序.assets/堆排序排升序建大堆示例.gif" style="zoom: 50%;" />
</center>
...
<center>
<img src="./6-八大排序.assets/冒泡排序.gif" style="zoom: 50%;" />
</center>
...
<center>
<img src="./6-八大排序.assets/冒泡排序与插入排序对比.gif" style="zoom: 50%;" />
</center>
...
<center>
<img src="./6-八大排序.assets/快速排序hoare关键字.png" style="zoom: 50%;" />
</center>

单趟排序完成后，<u>使数组中比`key`小的元素在数组的左边，比`key`大的在数组的右边</u>，最后关键字`key`也到了最终位置。

<center>
<img src="./6-八大排序.assets/快排hoare单趟排序结果示例.png" style="zoom: 50%;" />
</center>

**单趟排序的作用是将关键字`key`放到正确位置，顺便整理了一下数组使之更加有序**。类似于冒泡排序的将最大值放到尾处的最终位置，都是一趟排序排好一个数。

<center>
<img src="./6-八大排序.assets/快排单趟排序hoare版示例.gif" style="zoom: 50%;" />
</center>
...
<center>
<img src="./6-八大排序.assets/快排单趟排序下标顺序问题解释.gif" style="zoom: 50%;" />
</center>
...
<center>
<img src="./6-八大排序.assets/快速排序前后指针动例.gif" style="zoom: 50%;" />
</center>
...
<center>
<img src="./6-八大排序.assets/快速排序最佳复杂度分析.png" style="zoom: 50%;" />
</center>
...
<center>
<img src="./6-八大排序.assets/快速排序最差复杂度分析.png" style="zoom: 50%;" />
</center>
...
<center>
<img src="./6-八大排序.assets/小区间占大多数递归次数优化.png" style="zoom: 50%;" />
</center>
...
<center>
<img src="./6-八大排序.assets/合并两个有序数组动例.gif" style="zoom: 50%;" />
</center>
...
<center>
<img src="./6-八大排序.assets/归并排序分解归并理解.png" style="zoom: 50%;" />
</center>
...
<center>
<img src="./6-八大排序.assets/归并排序演示动例.gif" style="zoom: 50%;" />
</center>
...
<center>
<img src="./6-八大排序.assets/归并排序非递归理解.png" style="zoom: 50%;" />
</center>
...
<center>
<img src="./6-八大排序.assets/归并排序非递归越界问题.png" style="zoom: 50%;" />
</center>
...
<center>
<img src="./6-八大排序.assets/计数排序示例.png" style="zoom: 50%;" />
</center>
...
<center>
<img src="./6-八大排序.assets/直接选排不稳定.gif" style="zoom: 50%;" />
</center>

堆排序不稳定如下图：

<center>
<img src="./6-八大排序.assets/堆排序不稳定.gif" style="zoom: 50%;" />
</center>
