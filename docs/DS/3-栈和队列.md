...
<center>
<img src="./3-栈和队列.assets/进栈出栈.png" style="zoom:50%;" />
</center>
...
<center>
<img src="./3-栈和队列.assets/队列结构功能示例.gif" style="zoom:50%;" />
</center>
...
<center>
<img src="./3-栈和队列.assets/队列插入删除示例.gif" style="zoom:50%;" />
</center>
...
<center>
<img src="./3-栈和队列.assets/栈实现左右括号匹配.gif" style="zoom:50%;" />
</center>
...
<center>
<img src="./3-栈和队列.assets/队列实现栈结构体定义.png" style="zoom:50%;" />
</center>
...
<center>
<img src="./3-栈和队列.assets/队列实现栈的入栈操作.png" style="zoom:50%;" />
</center>
...
<center>
<img src="./3-栈和队列.assets/队列实现栈的出栈操作.png" style="zoom:50%;" />
</center>

3. `Top`，直接调用队列读取队尾元素的接口函数即可。

<center>
<img src="./3-栈和队列.assets/队列实现栈的获取栈顶元素操作.png" style="zoom:50%;" />
</center>
...
<center>
<img src="./3-栈和队列.assets/栈实现队列的结构体定义.png" style="zoom: 50%;" />
</center>
...
<center>
<img src="./3-栈和队列.assets/栈实现队列的入栈操作.gif" style="zoom: 50%;" />
</center>
...
<center>
<img src="./3-栈和队列.assets/栈实现队列的出栈操作.gif" style="zoom: 50%;" />
</center>
...
<center>
<img src="./3-栈和队列.assets/循环队列示例.gif" style="zoom: 50%;" />
</center>
...
<center>
<img src="./3-栈和队列.assets/循环队列判判满条件.png" style="zoom: 50%;" />
</center>
...
<center>
<img src="./3-栈和队列.assets/数组下标溢出模等返回下标.png" style="zoom:50%;" />
</center>
