...
<img src="./3-栈和队列.assets/进栈出栈图示.png" style="zoom:50%;" />
...
<img src="./3-栈和队列.assets/队列结构功能示例图示.gif" style="zoom:50%;" />
...
<img src="./3-栈和队列.assets/队列插入删除示例图示.gif" style="zoom:50%;" />
...
<img src="./3-栈和队列.assets/栈实现左右括号匹配图示.gif" style="zoom:50%;" />
...
<img src="./3-栈和队列.assets/队列实现栈结构体定义图示.png" style="zoom:50%;" />
...
<img src="./3-栈和队列.assets/队列实现栈的入栈操作图示.png" style="zoom:50%;" />
...
<img src="./3-栈和队列.assets/队列实现栈的出栈操作图示.png" style="zoom:50%;" />

3. `Top`，直接调用队列读取队尾元素的接口函数即可。

<img src="./3-栈和队列.assets/队列实现栈的获取栈顶元素操作图示.png" style="zoom:50%;" />
...
<img src="./3-栈和队列.assets/栈实现队列的结构体定义图示.png" style="zoom: 50%;" />
...
<img src="./3-栈和队列.assets/栈实现队列的入栈操作图示.gif" style="zoom: 50%;" />
...
<img src="./3-栈和队列.assets/栈实现队列的出栈操作图示.gif" style="zoom: 50%;" />
...
<img src="./3-栈和队列.assets/循环队列示例图示.gif" style="zoom: 50%;" />

1. 循环队列同样是队列，满足队列的所有性质，
2. 循环队列空间大小固定且可重复利用，
3. 需要多开辟一个元素的空间以用于判满。

<img src="./3-栈和队列.assets/循环队列判判满条件图示.png" style="zoom: 50%;" />
...
<img src="./3-栈和队列.assets/数组下标溢出模等返回下标图示.png" style="zoom:50%;" />
