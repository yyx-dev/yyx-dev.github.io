...
("./log/var(--vp-c-bg-soft)_file_sink.log");
log_sink::ptr sinker3 = sink_factory::create<log::rolling_sink>
("./log/var(--vp-c-bg-soft)_rolling_sink", 1024 * 1024);
...
("./log/var(--vp-c-bg-soft)_rolling_sink", log::memory_size::m1M);
...
ldirector->construct_sinker<log::file_sink>("./log/var(--vp-c-bg-soft)_file_sink.log");
ldirector->construct_sinker<log::rolling_sink>("./log/var(--vp-c-bg-soft)_rolling_sink",  m1M);
...
lg->debug(__FILE__, __LINE__, "%s-%d", "var(--vp-c-bg-soft) logger manager succ", 666);
```
...
```cpp
DEBUG("%s-%d", "var(--vp-c-bg-soft) global interface succ", 666);
INFO ("%s-%d", "var(--vp-c-bg-soft) global interface succ", 666);
WARN ("%s-%d", "var(--vp-c-bg-soft) global interface succ", 666);
ERROR("%s-%d", "var(--vp-c-bg-soft) global interface succ", 666);
FATAL("%s-%d", "var(--vp-c-bg-soft) global interface succ", 666);

logger::ptr logger = logger_manager::get_instance().get_logger("async_logger");
logger->debug("%s-%d", "var(--vp-c-bg-soft) global interface succ", 666);
logger->info ("%s-%d", "var(--vp-c-bg-soft) global interface succ", 666);
logger->warn ("%s-%d", "var(--vp-c-bg-soft) global interface succ", 666);
logger->error("%s-%d", "var(--vp-c-bg-soft) global interface succ", 666);
logger->fatal("%s-%d", "var(--vp-c-bg-soft) global interface succ", 666);
```
