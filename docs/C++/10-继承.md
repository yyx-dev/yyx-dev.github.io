...
<center>
<img src="./10-继承.assets/继承定义类举例示例.png" style="zoom:60%;" />
</center>
...
<center>
<img src="./10-继承.assets/父子类继承关系语法示例.png" style="zoom: 60%;" />
</center>
...
<center>
<img src="./10-继承.assets/子类赋值给父类赋值转换切片示例.png" style="zoom: 60%;" />
</center>
...
<center>
<img src="./10-继承.assets/子类默认构造和析构顺序动例.gif" style="zoom: 60%;" />
</center>
...
<center>
<img src="./10-继承.assets/单继承示例.png" style="zoom:60%;" />
</center>

多继承：一个子类有两个及以上的直接父类，这样的继承关系为多继承。

<center>
<img src="./10-继承.assets/多继承示例.png" style="zoom:60%;" />
</center>
...
<center>
<img src="./10-继承.assets/菱形继承示例.png" style="zoom:60%;" />
</center>
...
<center>
<img src="./10-继承.assets/菱形继承对象模型结构示例.png" style="zoom:60%;" />
</center>
...
<center>
<img src="./10-继承.assets/虚基表映射.png" style="zoom:50%;" />
</center>
