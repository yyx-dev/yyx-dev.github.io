...
<img src="./15-异常和智能指针.assets/自定义异常体系.png" style="zoom: 60%;" />
...
<img src="./15-异常和智能指针.assets/标准库异常类体系.png" style="zoom: 40%;" />
...
void var(--vp-c-bg-soft)_auto_ptr()
{
...
void var(--vp-c-bg-soft)_unique_ptr()
{
...
<img src="./15-异常和智能指针.assets/shared_ptr的引用计数原理.png" style="zoom: 30%;" />
...
<img src="./15-异常和智能指针.assets/shared_ptr的链表链接示例.png" style="zoom: 30%;" />
...
<img src="./15-异常和智能指针.assets/shared_ptr的循环引用问题.png" style="zoom: 35%;" />
...
void var(--vp-c-bg-soft)_weak_ptr()
{
    shared_ptr<ListNode> n1(new ListNode);
    shared_ptr<ListNode> n2(new ListNode);
