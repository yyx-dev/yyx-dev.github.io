...
<img src="./01-基础语法.assets/链接库文件设置库目录方法.png" style="zoom: 67%;" />

<img src="./01-基础语法.assets/链接库文件附加项库文件名.png" style="zoom: 67%;" />
...
<img src="./01-基础语法.assets/引用和变量的关系示例.png" style="zoom: 67%;" />
...
<img src="./01-基础语法.assets/常引用其他类型产生临时变量.png" style="zoom: 67%;" />
...
<img src="./01-基础语法.assets/引用修改单链表接口.png" style="zoom: 50%;" />
...
<img src="./01-基础语法.assets/返回值和返回引用的汇编代码对比.png" style="zoom: 67%;" />
...
<img src="./01-基础语法.assets/引用和指针汇编代码的对比.png" style="zoom: 67%;" />
...
<img src="./01-基础语法.assets/内联函数反汇编代码.png" style="zoom: 67%;" />
...
```cpp
void var(--vp-c-bg-soft)For(int arr[])
{
	for (auto e : arr)
		cout << e << endl;
}
...
<img src="./01-基础语法.assets/stddef定义null.png" style="zoom: 67%;" />
