...
p->var(--vp-c-bg-soft)() 把子类对象指针传给 var(--vp-c-bg-soft) 函数 this 形参，var(--vp-c-bg-soft) 函数的 this 类型是父类指针，相当于父类指针指向子类对象。
...
<img src="./11-多态.assets/含有虚函数的类中存储虚表指针.png" style="zoom: 67%;" />

含有虚函数的类，实例化后会有虚函数表指针`_vfptr`这一隐藏成员，存储在类的头四个字节空间。

虚表指针指向的空间称为虚函数表，用来存储虚函数的地址。

<img src="./11-多态.assets/虚表指针指向虚表存储虚函数地址示例.png" style="zoom: 60%;" />
...
<img src="./11-多态.assets/探究虚表的原理示例.png" style="zoom: 60%;" />
...
<img src="./11-多态.assets/成人学生买票构成多态示例.png" style="zoom: 67%;" />
...
<img src="./11-多态.assets/是否构成多态对虚函数的调用的区别示例.png" style="zoom: 60%;" />
...
<img src="./11-多态.assets/多继承方式的子类虚表示例.png" style="zoom: 67%;" />
