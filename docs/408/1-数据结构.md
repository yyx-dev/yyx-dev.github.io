...
> 线索用来直接指向遍历中前驱和后继，故分为先序/中序/后序线索二叉树。

方法：将结点的空左指针指向前驱，并置ltag为1，空右指针指向后继，并置rtag为1。

<center>
<img src="./1-数据结构.assets/线索二叉树.png" style="zoom: 80%;" />
</center>
